...
function generateBOTMTEReportCard($data)
{
    $pdf = new Fpdi();
...
function generateENDReportCard($data)
{
    $pdf = new Fpdi();
    $pdf->setPrintHeader(false);
    $pdf->setPrintFooter(false);
...
function generateBOTAndMTEReportCard($data)
{
    $pdf = new Fpdi();
    $pdf->setPrintHeader(false);
    $pdf->setPrintFooter(false);
...
function generateBOTORMTEEndReportCard($data)
{
    $pdf = new Fpdi();
    $pdf->setPrintHeader(false);
    $pdf->setPrintFooter(false);
...
function generateBOTMTEEndReportCard($data)
{
    $pdf = new Fpdi();
    $pdf->setPrintHeader(false);
    $pdf->setPrintFooter(false);
