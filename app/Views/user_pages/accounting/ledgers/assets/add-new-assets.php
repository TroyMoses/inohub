<div class="modal fade" id="ledger-asset-reg-modal" data-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Register Asset</h6><button aria-label="Close" class="btn-close"
                    data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">

                <form id="new-assets-registration-form" method="post"
                    action="<?= base_url('/Sys/Accounting/Ledgers/submitLedgerAssetsForm'); ?>" enctype="multipart/form-data">
                    <div class="row row-sm">
                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="bank_currency">Select Account:<span
                                        class="tx-danger">*</span></label>
                                <select name="account" class="form-control form-select form-control-sm"
                                    id="register_assets_account" data-bs-placeholder="Select Account" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="payment_method" class="form-control form-select form-control-sm"
                                    id="register_asst_payment_mtd" data-bs-placeholder="Select Payment Method" required>
                                    <option value="">---- Select ----- </option>
                            ...
                            <div class="form-group" style="display:none" id="payment-method-asst-acc-div">
                                ...
                                <select name="payment_method_account" class="form-control form-select form-control-sm"
                                    id="payment_method_asst_account" data-bs-placeholder="Select Account" required>
                                    <option value="">---- Select ----- </option>
                                </select>
                            </div>
            ...
            <div class="modal-footer">
                <button class="btn ripple btn-primary" id="btn-save-new-asset" type="button">Save Asset
                    Details</button>
