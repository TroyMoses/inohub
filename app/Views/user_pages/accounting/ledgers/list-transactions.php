            ...
            <div class="card-body">
                <div class="table-responsive  export-table" id="list-income-transactions-table">
                    <table id="pending-schools-datatable-1"
                        ...
                        <tbody>
                            <?php
                                // Start balance at 0 for each group
                                $balance = 0;
                            ?>
                            ...
                            <?php
                                // Calculate the balance for each transaction: debit - credit
                                $credit = $transaction->cr_dr == 'cr' ? $transaction->amount: 0;
                                $debit = $transaction->cr_dr == 'dr' ? $transaction->amount: 0;
                            ...
                            <tr>
                                ...
                                <td><?= $transaction->cr_dr == 'dr' ? esc(number_format($transaction->amount)): 0; ?></td>
                                <td><?= $transaction->cr_dr == 'cr' ? esc(number_format($transaction->amount)): 0; ?></td>
                                <td><?= $balance < 0 ? "(" . number_format(abs($balance)) . ")" : number_format($balance); ?></td> <!-- Balance column -->
                            ...
                            <tr style="font-weight:bold; background-color: #eef;">
                                ...
                                <td><?= number_format($group['total_credit']); ?></td>
                                <td><?= $balance < 0 ? "(" . number_format(abs($balance)) . ")" : number_format($balance); ?></td> <!-- Balance for the group -->
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                        ...
                        <?php
                            $grand_total1 = array_sum(array_column($transactions, 'total_debit'));
                            $grand_total2 = array_sum(array_column($transactions, 'total_credit'));
                            ?>
                        ...
                        <tfoot>
                            <tr style="font-weight:bold; background-color: #ddd;">
                                ...
                                <td>Grand Total</td>
                                <td></td>
                                <td><?= number_format($grand_total1); ?></td>
                                <td><?= number_format($grand_total2); ?></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
