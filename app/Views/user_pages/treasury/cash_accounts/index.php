                ...
                <div class="table-responsive  export-table">
                    <table id="pending-schools-datatable"
                        ...
                        <?php if (!empty($cash_accounts)) : ?>
                                <?php foreach ($cash_accounts as $key => $cash_account) : ?>
                                    <tr>
                                        <td><?= $key + 1; ?></td>
                                        <td><?= esc($cash_account->account_name); ?></td>
                                        <td><?= esc($cash_account->currency); ?></td>
                                        <td><?= $cash_account->balance ? $cash_account->balance->bal_row < 0 ? "(" . number_format(abs($cash_account->balance->bal_row)) . ")" : number_format($cash_account->balance->bal_row): 0; ?></td>
