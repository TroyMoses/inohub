                    ...
                    <table id="pending-schools-datatable"
                        ...
                        <?php if (!empty($bank_accounts)) : ?>
                                <?php foreach ($bank_accounts as $key => $bank_account) : ?>
                                    <tr>
                                        <td><?= $key + 1; ?></td>
                                        <td><?= esc($bank_account->bank_name); ?></td>
                                        <td><?= esc($bank_account->account_name); ?></td>
                                        <td><?= esc($bank_account->account_number); ?></td>
                                        <td><?= $bank_account->balance ? $bank_account->balance->bal_row < 0 ? "(" . number_format(abs($bank_account->balance->bal_row)) . ")" : number_format($bank_account->balance->bal_row): 0; ?></td>
                                        <td><?= esc($bank_account->currency); ?></td>
