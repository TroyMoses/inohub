                        ...
                        <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <select name="class_students_academic_years" class="form-control form-select form-control-sm"
                                    id="term_student_subjects_academic_years" data-bs-placeholder="Select Year" required>
                                    <option value="">---- Select ----- </option>
                                    <?php foreach ($academic_years as $key => $academic_year) : ?>
                                        <option id="term_students_sub_academic_years_<?= esc($academic_year->id); ?>" data-terms="<?= esc(json_encode($academic_year->terms)); ?>" value="<?= esc($academic_year->id); ?>"><?= esc($academic_year->name); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <select name="term" class="form-control form-select form-control-sm"
                                    id="term_students_sub_academic_years_terms" data-bs-placeholder="Select Status" required>
                                    <option value="">---- Select ----- </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4">
                            <div class="form-group">
                                <label class="form-label" for="identity_type">Class:<span
                                        class="tx-danger">*</span></label>
                                <select name="term_students_classes" class="form-control form-select form-control-sm"
                                    id="term_student_subject_classes_select" data-bs-placeholder="Select Status" required>
                                    <option value="">---- Select ----- </option>
                                </select>
                            </div>
                        </div>
...
<div id="view-term-students-subjects-page-view-div">
