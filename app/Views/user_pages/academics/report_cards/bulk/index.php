...
<div id="generate-report-card-html-div">
    <form method="post" action="" enctype="multipart/form-data">
        <div class="row row-sm">
            ...
            <div class="col-lg-3 col-xl-3 col-md-3 col-sm-3">
                <div class="form-group">
                    <label class="form-label" for="department_name">Class<span class="tx-danger">*</span></label>
                    <select class="form-control form-select form-control-sm" id="student-report-card-yr-class" data-bs-placeholder="Select Status" required>
                        <option value="">---- Select ----- </option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-xl-2 col-md-2 col-sm-2 pt-3">
                <button class="btn ripple btn-primary mt-4 btn-sm" id="btn-fetch-bulk-report-card"
    ...
    <div class="row row-sm">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div id="fetch-bulk-report-card-container"></div>
        </div>
    </div>
