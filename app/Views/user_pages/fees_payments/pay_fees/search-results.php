        ...
        <tbody>
            <?php foreach ($results as $key => $result) : ?>
                <tr>
                    ...
                    <td class="call-action"><button type="button" data-id="<?= h_encrypt_decrypt(esc($result->id)); ?>" class="btn btn-primary btn-sm view-student-details-pay-fees">--- pay---</button></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table> 
