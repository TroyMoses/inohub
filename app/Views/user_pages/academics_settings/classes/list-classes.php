                            ...
                            <?php if (!empty($classes)) : ?>
                                <?php foreach ($classes as $key => $class) : ?>
                                    <tr>
                                        ...
                                        <td><?= esc($class->short_name); ?></td>
                                        <td><?= esc($class->status); ?></td>
                                        <td><?= esc($class->date_added); ?></td>
                                        <td class="call-action no-print">
                                            <button type="button" class="btn btn-primary btn-sm btn-edit-school-class"
                                                data-id="<?= esc($class->id); ?>">
                                                Edit
                                            </button>
                                            <button type="button"
                                                class="btn btn-danger btn-sm btn-delete-class"
                                                data-id="<?= esc($class->id); ?>"
                                                data-label="<?= esc($class->name); ?>">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
