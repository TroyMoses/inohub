                    ...
                    <table id="pending-schools-datatable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">Subject Type</th>
                            ...
                            <?php if (!empty($subjects)) : ?>
                                <?php foreach ($subjects as $key => $subject) : ?>
                                    <tr>
                                        ...
                                        <td><?= esc($subject->date_added); ?></td>
                                        <td class="call-action">
                                            <button type="button" class="btn btn-primary btn-sm btn-edit-subject" data-id="<?= esc($subject->id); ?>">Edit</button>
