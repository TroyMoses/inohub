        ...
        <div style="margin-bottom: 10px;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                <div style="display: flex; align-items: center; flex: 1; margin-right: 20px;">
                    <strong style="white-space: nowrap; font-size:12">Position In Class:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{beginning_term_position_in_class}</span>
                </div>
                <div style="display: flex; align-items: center; flex: 1;">
                    <strong style="white-space: nowrap; font-size:12">Out Of:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{beginning_term_out_of}</span>
                </div>
            </div>
        </div>
        <!-- position Table -->
    ...
    <div class="class-report-card">
        <div style="margin-bottom: 10px;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                <div style="display: flex; align-items: center; flex: 1; margin-right: 20px;">
                    <strong style="white-space: nowrap; font-size:12">Position In Class:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{mid_term_position_in_class}</span>
                </div>
                <div style="display: flex; align-items: center; flex: 1;">
                    <strong style="white-space: nowrap; font-size:12">Out Of:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{mid_term_out_of}</span>
                </div>
            </div>
        </div>
        <!-- Grades Table -->
    ...
    <div class="class-report-card">
        <div style="margin-bottom: 10px;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                <div style="display: flex; align-items: center; flex: 1; margin-right: 20px;">
                    <strong style="white-space: nowrap; font-size:12">Position In Class:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{end_term_position_in_class}</span>
                </div>
                <div style="display: flex; align-items: center; flex: 1;">
                    <strong style="white-space: nowrap; font-size:12">Out Of:</strong>
                    <span style="flex: 1; margin-left: 10px; color: rgb(184, 49, 47); border-bottom: 1px dotted black; font-size:12">{end_term_out_of}</span>
                </div>
            </div>
        </div>
        <!-- Grades Table -->
