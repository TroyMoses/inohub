                    ...
                    <table id="pending-schools-datatable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">Head Of Department</th>
                        ...
                        <tbody>
                            <?php if (!empty($departments)) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= esc($department->parent_department_id); ?></td>
                                    <td><?= esc($department->person_name); ?></td>
                                    <td><?= esc($department->status == 0? 'Active': 'Inactive'); ?></td>
                                    <td class="call-action"><button type="button" class="btn btn-primary btn-sm edit-department-btn" data-id="<?= esc($department->id); ?>">Edit</button>
...
<div id="edit-department-container"></div> <!-- for dynamic modal injection -->
