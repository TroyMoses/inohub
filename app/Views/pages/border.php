						...
						<div class="card">
							<div class="card-body">
								...
								<div class="table-responsive mg-t-25">
									<table class="table main-table-reference mg-b-0 mg-t-10">
										<thead>
											<tr>
										...
										<tbody>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd"</code></td>
												<td>Add border in all sides of an element using default color and width.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-t"</code></td>
												<td>Add border to top side of element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-e"</code></td>
												<td>Add border to right side of element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-b"</code></td>
												<td>Add border to bottom side of element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-s"</code></td>
												<td>Add border to left side of element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-x"</code></td>
												<td>Add border to left and right side of element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd-y"</code></td>
								...
								<div class="table-responsive mg-t-25">
									<table class="table main-table-reference text-nowrap mg-b-0 mg-t-10">
										...
										<tbody>
											...
											<tr>
												<td><code class="p-0 bg-transparent">class="bd bd-2"</code></td>
												<td>Set 2px border to element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd bd-3"</code></td>
												<td>Set 3px border to element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd bd-4"</code></td>
												<td>Set 4px border to element.</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">class="bd bd-5"</code></td>
							...
							<div class="card-body">
								...
								<div class="table-responsive mg-t-25">
									<table class="table main-table-reference text-nowrap mg-b-0 mg-t-10">
										...
										<tbody>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-t-0</code></td>
												<td>Remove top border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-e-0</code></td>
												<td>Remove right border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-b-0</code></td>
												<td>Remove bottom border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-s-0</code></td>
												<td>Remove left border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-x-0</code></td>
												<td>Remove left and right border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-y-0</code></td>
												<td>Remove top and bottom border of an element</td>
											</tr>
											<tr>
												<td><code class="p-0 bg-transparent">.bd-[t||r|bl|x|y]-0-f</code></td>
									...
									<table class="table main-table-reference text-nowrap mg-b-0 mg-t-0">
										<tbody>
											<tr>
												...
												<td><code class="p-0 bg-transparent">.bd-[value]</code></td>
												<td><code class="p-0 bg-transparent">.bd-gray-[value]</code></td>
											</tr>
											<tr>
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="table-responsive mg-t-20 mb-0">
									<table class="table main-table-reference mg-b-0 mg-t-0">
										<tbody>
											<tr>
												<td class="bg-gray-100 wd-20p"><b>Classes</b></td>
												<td><code class="p-0 bg-transparent">.radius</code></td>
												<td><code class="p-0 bg-transparent">.radius-[value]</code></td>
											</tr>
											<tr>
												<td class="bg-gray-100 wd-20p"><b>Values</b></td>
