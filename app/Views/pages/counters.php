								...
								<div class="card-body">
									<div class="example bg-primary-transparent border-primary text-primary">
										<div class="d-block d-sm-flex">
											<span class="tx-30 pe-3"><i class="bi bi-alarm"></i></span>
											<div class="">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body mx-auto">
									<div class="example bg-info text-white border border-info pb-4 px-5 position-relative">
										<div class="counter-side-badge"> 
											<span class="badge bg-danger">Hurry Up</span> 
										</div>
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1">
									...
									<img src="<?php echo base_url('assets/img/media/illustrate.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1">
									...
									<img src="<?php echo base_url('assets/img/media/illustrate1.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1 ">
									...
									<img src="<?php echo base_url('assets/img/media/illustrate2.png'); ?>" alt="counter-image" class="wd-300 ht-300 ">
