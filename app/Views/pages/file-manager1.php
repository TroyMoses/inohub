					...
					<div class="row">
						<div class="col-lg-12 col-xl-12">
								...
								<div class="row">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
												   <a href="<?php echo base_url('file-details'); ?>">
													   <img src="<?php echo base_url('assets/img/files/folder.png'); ?>" alt="img" class="br-7">
                                                    </a>
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="<?php echo base_url('assets/img/files/file.png'); ?>" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="file-manger-icon">
												   <a href="<?php echo base_url('file-details'); ?>">
													   <img src="<?php echo base_url('assets/img/files/word.png'); ?>" alt="img" class="br-7">
                                                    </a>
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="file-manger-icon">
												   <a href="<?php echo base_url('file-details'); ?>">
													   <img src="<?php echo base_url('assets/img/files/doc.png'); ?>" alt="img" class="br-7">
                                                    </a>
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="file-manger-icon">
												   <a href="<?php echo base_url('file-details'); ?>">
													   <img src="<?php echo base_url('assets/img/files/image.png'); ?>" alt="img" class="br-7">
                                                    </a>
												</div>
							...
							<ul class="pagination float-end mb-4">
								...
								<li class="page-item page-next"><a class="page-link" href="javascript:void(0);">Next</a>
								</li>
						    </ul>
						</div>
					</div>
