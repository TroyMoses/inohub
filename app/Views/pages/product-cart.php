<?= $this->extend('layouts/switcher-main'); ?>
						...
						<div class="col-lg-12 col-xl-9 col-md-12">
							<div class="card">
											...
											<tbody>
												...
												<tr>
													<td>
														<div class="media">
															<div class="card-aside-img">
																<img src="<?php echo base_url('assets/img/ecommerce/09.jpg'); ?>" alt="img" class="h-60 w-60">
															</div>
															<div class="media-body">
																<div class="card-item-desc mt-0">
								...
								<div class="card-footer">
									<div class="shopping-cart-footer bd-0">
										<div class="column"><a class="btn btn-secondary" href="<?php echo base_url('shop'); ?>"><i class="fe fe-corner-up-left  mx-2"></i>Back to Shopping</a></div>
										<div class="column">
											<a class="btn btn-primary" href="<?php echo base_url('product-cart'); ?>"><i class="fe fe-refresh-cw mx-2"></i>Update Cart</a>
											<a class="btn btn-outline-primary" href="<?php echo base_url('check-out'); ?>"><i class="fe fe-log-in mx-2"></i>Checkout</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-12 col-xl-3 col-md-12">
								...
								<div class="card custom-card cart-details">
									...
									<div class="card-footer">
										<div class="column"><a class="btn btn-primary" href="<?php echo base_url('shop'); ?>">Continue Shopping</a></div>
									</div>
								</div>
							</div>
					</div>
    ...
    <?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/js/handleCounter.js'); ?>"></script>
