    ...
    <?= $this->section('content'); ?>
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">BOOTSTRAP INPUT SPINNERS</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Pages</a></li>
								<li class="breadcrumb-item active" aria-current="page">Bootstrap Input Spinners</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="card">
								...
								<div class="card-body pb-3">
									...
									<div class="mb-3 is-loading">
										<input class="form-control is-invalid" placeholder="is-invalid spinner-border" />
										<div class="spinner-border"></div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body pb-3">
									...
									<div class="mb-3 is-loading">
										<input class="form-control form-control-sm is-invalid" placeholder="form-control-sm is-invalid spinner-border spinner-border-sm" />
										<div class="spinner-border spinner-border-sm"></div>
									</div>
								</div>
							</div>
							<div class="card">
								...
								<div class="card-body pb-3">
									...
									<div class="mb-3 is-loading">
										<input class="form-control form-control-lg is-invalid" placeholder="form-control-lg is-invalid spinner-border spinner-border-sm" />
										<div class="spinner-border spinner-border-sm"></div>
									</div>
									...
									<div class="mb-3 is-loading">
										<input class="form-control form-control-lg is-invalid" placeholder="form-control-lg is-invalid spinner-border" />
										<div class="spinner-border"></div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body pb-3 spinner-input-group">
						...
						<div class="col-sm-12">
							<div class="card">
								...
								<div class="card-body pb-3 spinner-input-group">
									<div class="mb-3">
										<div class="input-group multiple-input-group input-group-rtl">
