								...
								<div class="card-body ht-100p">
									...
									<div>
										<div class="carousel slide carousel-fade" data-bs-ride="carousel" id="carouselExample5">
											...
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100" src="<?php echo base_url('assets/img/photos/4.jpg'); ?>">
												</div>
												<div class="carousel-item">
								...
								<div class="card-body ht-100p">
									...
									<div id="basicSlider">
										<div class="MS-content">
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/1.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/2.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/3.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/4.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/5.jpg'); ?>" alt=""   class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/6.jpg'); ?>" alt=""   class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/7.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/8.jpg'); ?>" alt="" class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/9.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/10.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="<?php echo base_url('assets/img/photos/5.jpg'); ?>" alt=""  class="br-5"> </a>
											</div>
