...
<?= $this->extend('layouts/switcher-main'); ?>
    ...
    <?= $this->section('content'); ?>
            ...
            <div class="container">
                ...
                <div class="row br-5">
                    <p><img src="<?php echo base_url('assets/img/photos/aboutmain.jpg'); ?>" class="br-5"  alt="image"></p>
                </div>
                <div class="row py-5 about-motto pt-0">
                ...
                <div class="row mb-5">
                        ...
                        <div class="card p-3">
                            <div class="card-body">
                                <div class="mb-3 text-center about-team">
                                    <img class="rounded-pill" src="<?php echo base_url('assets/img/faces/1.jpg'); ?>" alt="image">
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                        <div class="card p-3">
                            <div class="card-body">
                                <div class="mb-3 text-center about-team">
                                    <img class="rounded-pill" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>" alt="image">
                                </div>
                                <div class="tx-16 text-center font-weight-semibold">
                                    Mclaren mcannen
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                        <div class="card p-3">
                            <div class="card-body">
                                <div class="mb-3 text-center about-team">
                                    <img class="rounded-pill" src="<?php echo base_url('assets/img/faces/3.jpg'); ?>" alt="image">
                                </div>
                                <div class="tx-16 text-center font-weight-semibold">
                                    Shimpa Craig
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                        <div class="card p-3">
                            <div class="card-body">
                                <div class="mb-3 text-center about-team">
                                    <img class="rounded-pill" src="<?php echo base_url('assets/img/faces/4.jpg'); ?>" alt="image">
                                </div>
                                <div class="tx-16 text-center font-weight-semibold">
                                    Limo Peter
                                </div>
