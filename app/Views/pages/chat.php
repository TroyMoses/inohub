													...
													<div class="content-inner">
														...
														<div class="media flex-row-reverse">
															...
															<div class="media-body">
																...
																<div class="main-msg-wrapper p-0"><img alt="" class="wd-100 ht-100 br-5" src="<?php echo base_url('assets/img/ecommerce/6.jpg'); ?>"></div>
																<div>
											...
											<div class="card-body p-0 chat-main">
											    <div class="float-end ms-auto m-4">
													<div class="dropdown show main-contact-star">
														<a class="new option-dots" data-bs-toggle="dropdown" href="JavaScript:void(0);">
															<i class="fe fe-more-vertical  tx-18"></i>
														</a>
												...
												<div class="text-center border-bottom chat-image p-4 pb-0 mb-4 br-5 mt-3">
													...
													<a href="<?php echo base_url('profile'); ?>"><h5 class="mb-1">Ryan Gracie</h5></a>
