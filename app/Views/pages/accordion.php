										...
										<div class="border p-3 accstyle border-top-0">
											<div class="row">
												<div class="col-lg-3 col-md-6">
													<img class="img-fluid rounded m-2" src="<?php echo base_url('assets/img/photos/8.jpg '); ?>" alt="banner image">
												</div>
												<div class="col-lg-3 col-md-6">
													<img class="img-fluid rounded m-2" src="<?php echo base_url('assets/img/photos/10.jpg'); ?>" alt="banner image ">
												</div>
												<div class="col-lg-3 col-md-6">
													<img class="img-fluid rounded m-2" src="<?php echo base_url('assets/img/photos/8.jpg'); ?>" alt="banner image ">
												</div>
												<div class="col-lg-3 col-md-6">
													<img class="img-fluid rounded m-2" src="<?php echo base_url('assets/img/photos/12.jpg'); ?>" alt="banner image ">
												</div>
											</div>
										</div>
									</div>
					...
					<div class="card">
						...
						<div class="card-footer">
							<table class="table main-table-reference mt-0 mb-0">
								...
								<tbody>
									<tr>
										<td><code class="p-0 bg-transparent">class="accordion accordion-[value]"</code></td>
