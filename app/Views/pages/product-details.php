										...
										<div class="row">
															...
															<ul class="carousel-item active">
																<li data-bs-target="#Slider" data-bs-slide-to="0"
																	class="thumb active my-2"><img
																		src="<?php echo base_url('assets/img/ecommerce/shirt-1.png'); ?>"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="1"
																	class="thumb my-2"><img
																		src="<?php echo base_url('assets/img/ecommerce/shirt-3.png'); ?>"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="2"
																	class="thumb my-2"><img
																		src="<?php echo base_url('assets/img/ecommerce/shirt-4.png'); ?>"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="3"
																	class="thumb my-2"><img
																		src="<?php echo base_url('assets/img/ecommerce/shirt-2.png'); ?>"
																		alt="img"></li>
															</ul>
														</div>
													</div>
											...
											<div class="col-xxl-10">
													...
													<div id="Slider" class="carousel slide" data-bs-ride="false">
														<div class="carousel-inner">
															<div class="carousel-item active"><img
																	src="<?php echo base_url('assets/img/ecommerce/shirt-1.png'); ?>" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center mt-5 mb-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="<?php echo base_url('assets/img/ecommerce/shirt-3.png'); ?>" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center mb-5 mt-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="<?php echo base_url('assets/img/ecommerce/shirt-4.png'); ?>" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center  mb-5 mt-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="<?php echo base_url('assets/img/ecommerce/shirt-2.png'); ?>" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center  mb-5 mt-5 btn-list">
																</div>
															</div>
												...
												<div class="text-center  mt-4">
													<a href="product-cart.html" class="btn ripple btn-primary me-2"><i
															class="fe fe-shopping-cart"> </i> Add to cart</a>
													<a href="check-out.html" class="btn ripple btn-secondary"><i
															class="fe fe-credit-card"> </i> Buy Now</a>
												</div>
											</div>
										</div>
									</div>
									<div class="details col-xxl-6 col-lg-6 col-md-6 mt-4 mt-xl-0">
								...
								<div class="media mt-0 p-3 border-bottom border-top">
									<div class="d-flex me-3">
										<a href="javascript:void(0);"><img
												...
												src="<?php echo base_url('assets/img/faces/6.jpg'); ?>"> </a>
									</div>
				...
				<div class="row">
					<div class="col-lg-3 col-xl-3 col-sm-6">
						<div class="card item-card">
							...
							<div class="text-center border-top pt-3 pb-3 ps-2 pe-2 ">
								...
								<a href="<?php echo base_url('product-cart'); ?>" class="btn btn-secondary mb-0 mb-lg-2"><i
					...
					<div class="col-lg-3 col-sm-6">
						<div class="card item-card">
							<div class="card-body pb-0 h-100  product-grid6">
								<div class="text-center product-image">
									<img src="<?php echo base_url('assets/img/ecommerce/5.jpg'); ?>" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative">
									<div class="cardtitle">
