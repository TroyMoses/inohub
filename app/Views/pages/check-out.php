<?= $this->extend('layouts/switcher-main'); ?>
													...
													<section>
														...
														<div class="product">
															<div class="item flex-wrap">
																<div class="left"> <a href="javascript:void(0);" class="thumb radius"> <img src="<?php echo base_url('assets/img/ecommerce/09.jpg'); ?>" alt="" class="radius"> </a>
																	<div class="purchase">
															...
															<div class="item flex-wrap">
																<div class="left"> <a href="javascript:void(0);" class="thumb radius"> <img src="<?php echo base_url('assets/img/ecommerce/03.jpg'); ?>" alt="" class="radius"> </a>
																	<div class="purchase">
    ...
    <?= $this->section('scripts'); ?>
		...
		<!-- Jquery-steps js -->
		<script src="<?php echo base_url('assets/plugins/checkout-jquery-steps/jquery.steps.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/checkout-jquery-steps.js'); ?>"></script>
