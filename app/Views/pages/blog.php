    ...
    <?= $this->endSection('styles'); ?>
        ...
        <?= $this->section('content'); ?>
					...
					<div class="row">
						<div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12">
							<div class="card overflow-hidden">
								<a href="<?php echo base_url('blog-details'); ?>" class="card custom-card card-img-top-1 background-image-blog mb-0">
								</a>
								<div class="card-body">
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100" src="<?php echo base_url('assets/img/photos/11.jpg'); ?>" alt=""></a>
								<div class="card-body pb-0">
									<a href="<?php echo base_url('blog-details'); ?>"><h4 class="card-title">10 Ways To Immediately Start Selling Products !</h4></a>
								...
								<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
									...
									<img alt="avatar" src="<?php echo base_url('assets/img/faces/9.jpg'); ?>">
									</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="media d-flex mb-4">
											<img alt="" class="main-img-user avatar-lg mg-r-20 br-5" src="<?php echo base_url('assets/img/photos/blog1.jpg'); ?>">
											<div class="media-body">
												<span class="d-block">Tourism</span>
												<p class="mb-0 font-weight-semibold">Explore tourism by visitinig places.</p>
												<small class="d-block text-muted">2 day ago</small>
											</div>
										</div>
										<div class="media d-flex mb-4">
											<img alt="" class="main-img-user avatar-lg mg-r-20 br-5" src="<?php echo base_url('assets/img/photos/blog2.jpg'); ?>">
											<div class="media-body">
												<span class="d-block">Beautician</span>
												<p class="mb-0 font-weight-semibold">Beautification courses are available.</p>
												<small class="d-block text-muted">2 hrs ago</small>
											</div>
										</div>
										<div class="media d-flex mb-4">
											<img alt="" class="main-img-user avatar-lg mg-r-20 br-5" src="<?php echo base_url('assets/img/photos/blog5.jpg'); ?>">
											<div class="media-body">
												<span class="d-block">Music</span>
												<p class="mb-0 font-weight-semibold">Music in a peaceful way.</p>
												<small class="d-block text-muted">1 day ago</small>
											</div>
										</div>
										<div class="media d-flex mb-4">
											<img alt="" class="main-img-user avatar-lg mg-r-20 br-5" src="<?php echo base_url('assets/img/photos/blog4.jpg'); ?>">
											<div class="media-body">
												<span class="d-block">Literature</span>
												<p class="mb-0 font-weight-semibold">English and spanish classes in Your way</p>
												<small class="d-block text-muted">1 week ago</small>
											</div>
										</div>
										<div class="media d-flex mb-3">
											<img alt="" class="main-img-user avatar-lg mg-r-20 br-5" src="<?php echo base_url('assets/img/photos/blog6.jpg'); ?>">
											<div class="media-body">
												<span class="d-block">Health</span>
												<p class="mb-0 font-weight-semibold">Health care and fitness awareness.</p>
					...
					<div class="row ">
						<div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100" src="<?php echo base_url('assets/img/photos/2.jpg'); ?>" alt=""></a>
								<div class="card-body pb-0">
									<a href="<?php echo base_url('blog-details'); ?>"><h4 class="card-title">How To Become Better With Building In 1 Month !</h4></a>
								...
								<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
									<div class="main-img-user online">
									<img alt="avatar" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>">
									</div>
									<div class="main-contact-body">
										<h6>Abigail John</h6>
									</div>
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100" src="<?php echo base_url('assets/img/photos/1.jpg'); ?>" alt=""></a>
								<div class="card-body pb-0">
									<a href="<?php echo base_url('blog-details'); ?>"><h4 class="card-title">10 Ways To Immediately Start Selling Products !</h4></a>
									<p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
									</div>
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100" src="<?php echo base_url('assets/img/photos/9.jpg'); ?>" alt=""></a>
								<div class="card-body pb-0">
									<a href="<?php echo base_url('blog-details'); ?>"><h4 class="card-title">3 Easy Ways To Make Your mobile Faster & Even !</h4></a>
									<p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
								</div>
								<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
									<div class="main-img-user online">
									<img alt="avatar" src="<?php echo base_url('assets/img/faces/7.jpg'); ?>">
									</div>
									<div class="main-contact-body">
										<h6>Raven Chanan</h6>
									</div>
								   ...
								   <a href="javascript:void(0);" class="border-0">
										<div class="list-group-item list-group-item-action">
											<div class="media mt-0">
												<img class="avatar-lg rounded-circle me-3 my-auto" src="<?php echo base_url('assets/img/faces/3.jpg'); ?>" alt="Image description">
												<div class="media-body">
										 ...
										 <a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="<?php echo base_url('assets/img/faces/11.jpg'); ?>" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="<?php echo base_url('assets/img/faces/17.jpg'); ?>" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="<?php echo base_url('assets/img/faces/15.jpg'); ?>" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="<?php echo base_url('assets/img/faces/13.jpg'); ?>" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
																<h5 class="mb-1 tx-13 font-weight-sembold text-dark">Manuel Labor</h5>
