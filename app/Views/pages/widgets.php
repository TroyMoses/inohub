								...
								<div class="card-body list-icons">
									...
									<div class="card-footer p-0">
										<p class="text-muted mb-0 pt-4">
											<i class="si si-arrow-down-circle text-warning mx-2" aria-hidden="true"></i> Daily Orders
										</p>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12 col-lg-6 col-xl-3">
							<div class="card card-img-holder">
								<div class="card-body list-icons">
									...
									<div class="card-footer p-0">
										<p class="text-muted mb-0 pt-4">
											<i class="si si-arrow-up-circle text-success mx-2"></i> Less Sales
										</p>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12 col-lg-6 col-xl-3">
							<div class="card card-img-holder">
								<div class="card-body list-icons">
									...
									<div class="card-footer p-0">
										<p class="text-muted mb-0 pt-4">
											<i class="si si-exclamation text-info mx-2"></i> From Last Month
										</p>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-12 col-lg-6 col-xl-3">
							<div class="card card-img-holder">
								<div class="card-body list-icons">
									...
									<div class="card-footer p-0">
										<p class="text-muted mb-0 pt-4">
											<i class="si si-check text-primary mx-2"></i> Recent History
										</p>
									</div>
								</div>
							</div>
								...
								<div class="card-body iconfont text-start">
									...
									<div class="d-flex mb-0">
										...
										<div class="card-chart bg-pink-transparent brround ms-auto mt-0">
											<i class="typcn typcn-chart-line-outline text-pink"></i>
										</div>
									</div>
								...
								<div class="card-body iconfont text-start">
									...
									<div class="d-flex mb-0">
										...
										<div class="card-chart bg-teal-transparent brround ms-auto mt-0">
											<i class="typcn typcn-chart-bar-outline text-teal"></i>
										</div>
									</div>
								...
								<div class="card-body iconfont text-start">
									...
									<div class="d-flex mb-0">
										...
										<div class="card-chart bg-purple-transparent brround ms-auto mt-0">
											<i class="typcn typcn-time  text-purple"></i>
										</div>
									</div>
							...
							<div class="card ">
								<div class="card-body">
									<div class="card-widget">
										...
										<h2 class="text-end"><i class="mdi mdi-cart-outline icon-size float-start text-danger text-danger-shadow"></i><span>46,486</span></h2>
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex">
											...
											<div class="feature-1 ms-auto">
												<div class="feature">
												<span class="text-start"><i class="icon icon-user  text-success ms-1"></i><b> 29,350</b> Male</span>
									            <p class="mt-4"><i class="icon icon-user-female  text-danger ms-1"></i><b> 10,718</b> Femlae</p>
												</div>
											</div>
										</div>
									</div>
									...
									<ul class="list list-noborders pb-0 mb-0">
										<li class="list-item">
											...
											<div class="ms-auto d-flex">
												<img class="img-sm me-1" src="<?php echo base_url('assets/img/ecommerce/03.jpg'); ?>" alt="thumb images">
										...
										<li class="list-item">
											...
											<div class="ms-auto d-flex">
												<img class="img-sm me-1" src="<?php echo base_url('assets/img/ecommerce/04.jpg'); ?>" alt="thumb images">
										...
										<li class="list-item">
											...
											<div class="ms-auto d-flex">
												<img class="img-sm me-1" src="<?php echo base_url('assets/img/ecommerce/06.jpg'); ?>" alt="thumb images">
										...
										<li class="list-item">
											...
											<div class="ms-auto d-flex">
												<img class="img-sm me-1" src="<?php echo base_url('assets/img/ecommerce/08.jpg'); ?>" alt="thumb images">
								...
								<div class="card-body p-0">
									<div class="browser-stats">
										<div class="d-flex align-items-center item  border-bottom">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/chrome.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
													<h6 class="">Chrome</h6>
										...
										<div class="d-flex align-items-center item  border-bottom">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/opera.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
													<h6 class="">Opera</h6>
													<span class="sub-text">Mozilla Foundation, Inc.</span>
												</div>
										...
										<div class="d-flex align-items-center item  border-bottom">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/edge.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
													<h6 class="">Edge</h6>
													<span class="sub-text">Mozilla Foundation, Inc.</span>
												</div>
										...
										<div class="d-flex align-items-center item  border-bottom">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/firefox.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
													<h6 class="">Firefox</h6>
													<span class="sub-text">Mozilla Foundation, Inc.</span>
												</div>
										...
										<div class="d-flex align-items-center item border-bottom">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/uc-browser.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
										...
										<div class="d-flex align-items-center item">
											<div class="d-flex">
												<img src="<?php echo base_url('assets/img/svgicons/safari.svg'); ?>" alt="img" class="ht-30 wd-30 me-2">
												<div class="">
													<h6 class="">Safari</h6>
													<span class="sub-text">Mozilla Foundation, Inc.</span>
												</div>
