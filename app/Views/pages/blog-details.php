					...
					<div class="row">
						<div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12">
							<div class="card overflow-hidden">
								<div class="item7-card-img px-4 pt-4">
									...
									<img src="<?php echo base_url('assets/img/photos/blog.jpg'); ?>" alt="img" class="cover-image br-5 w-100">
								</div>
								<div class="card-body">
								...
								<div class="card-footer pb-2 pt-2">
									<div class="item7-card-desc d-md-flex">
										<div class="d-flex align-items-center mt-0">
											<img src="<?php echo base_url('assets/img/faces/2.jpg'); ?>" class="avatar brround avatar-md me-3" alt="avatar-img">
											<div>
												<a href="<?php echo base_url('profile'); ?>" class="text-default font-weight-bold">Lilly Potter</a>
									...
									<div class="card-body">
										<div class="d-sm-flex mt-0 p-3 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
											<div class="d-flex me-3">
												<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('assets/img/faces/1.jpg'); ?>"> </a>
											</div>
										...
										<div class="d-sm-flex p-3 mt-4 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex me-3">
												<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('assets/img/faces/3.jpg'); ?>"> </a>
											</div>
											<div class="media-body">
										...
										<div class="d-sm-flex p-3 mt-4 border sub-review-section pb-0">
											<div class="d-flex me-3">
												<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('assets/img/faces/5.jpg'); ?>"> </a>
											</div>
											<div class="media-body">
										...
										<div class="d-sm-flex p-3 mt-4 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex me-3">
												<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>"> </a>
											</div>
											<div class="media-body">
						...
						<div class="col-xxl-3 col-xl-12 col-lg-12 col-md-12">
							...
							<div class="card custom-card overflow-hidden">
								...
								<div class="card-body">
									<div class="text-center">
										<a href="<?php echo base_url('blog-details'); ?>"><img class="card-img-top w-100 w-100 br-5" src="<?php echo base_url('assets/img/photos/11.jpg'); ?>" alt=""></a>
							...
							<div class="card custom-card overflow-hidden">
								...
								<div class="card-body">
									<ul class="list-group mb-0">
										...
										<img src="<?php echo base_url('assets/img/photos/blog5.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
											<div class="">
										...
										<li class="list-group-item d-flex border-0 px-0">
											<img src="<?php echo base_url('assets/img/photos/blog2.jpg'); ?>" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
											<div class="">
										...
										<div class="mt-2">
											<div class="masonry row">
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/1.jpg'); ?>" class="js-img-viewer" data-caption="IMAGE-01"
															data-id="lion">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/2.jpg'); ?>" class="js-img-viewer" data-caption="IMAGE-02"
															data-id="camel">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/3.jpg'); ?>" class="js-img-viewer" data-caption="IMAGE-03"
															data-id="hippo">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/4.jpg'); ?>" class="js-img-viewer" data-caption="IMAGE-04"
															data-id="koala">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/5.jpg'); ?>"  class="js-img-viewer" data-caption="IMAGE-05"
															data-id=" bear">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/6.jpg'); ?>" class=" js-img-viewer" data-caption="IMAGE-06"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/7.jpg'); ?>" class=" js-img-viewer" data-caption="IMAGE-07"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/8.jpg'); ?>" class=" js-img-viewer" data-caption="IMAGE-08"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="<?php echo base_url('assets/img/photos/9.jpg'); ?>" class=" js-img-viewer" data-caption="IMAGE-09"
															data-id=" rhino">
