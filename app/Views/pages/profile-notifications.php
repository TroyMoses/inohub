                        ...
                        <ul class="notification">
                                ...
                                <div class="notification-body">
									<div class="media mt-0">
										<div class="main-img-user avatar-md main-avatar online me-3 shadow">
											<a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/6'); ?>.jpg"></a>
										</div>
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar offline mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/1'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar online mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/15'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                               ...
                               <div class="notification-icon">
                                  <a href="javascript:void(0);"></a>
                               	...
                               	<div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar online mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/2'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                            ...
                            <li>
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar offline mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/11'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                             ...
                             <li>
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar online mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/13'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                             ...
                             <li>
                                ...
                                <div class="notification-body">
                                    <div class="media mt-0">
                                        <div class="main-img-user avatar-md main-avatar online mb-3  me-3 my-auto shadow">
                                            <a class="" href="<?php echo base_url('profile'); ?>"><img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/4'); ?>.jpg"></a>
                                        </div>
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
