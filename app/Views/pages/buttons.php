									...
									<div class="text-wrap">
										<div class="example">
											<div class="btn-icon-list btn-list">
												...
												<button type="button" class="btn btn-icon  btn-danger me-1 d-none d-sm-flex"><i class="fe fe-trash"></i></button>
												<button type="button" class="btn btn-icon  btn-purple me-1 d-none d-sm-flex"><i class="fe fe-bar-chart"></i></button>
											</div>
										</div>
									</div>
								</div>
											...
											<div class="row row-sm">
												<div class="col-lg-6">
													<div aria-label="Basic example" class="btn-group" role="group">
														<button class="btn btn-secondary active" type="button">Left</button> <button class="btn btn-secondary" type="button">Center</button> <button class="btn btn-secondary" type="button">Right</button>
													</div>
												</div><!-- col-4 -->
