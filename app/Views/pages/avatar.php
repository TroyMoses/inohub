						...
						<div class="col-xl-6 col-md-12">
							<div class="card custom-card" id="sizes">
								<div class="card-body">
									...
									<div class="text-wrap">
										<div class="example">
											<div class="demo-avatar-group d-block d-sm-flex">
												...
												<div class="demo-avatar-group">
													<div class="demo-avatar-group">
														...
														<div class="main-img-user1 avatar-md me-4">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/1.jpg'); ?>">
															<span class="badge rounded-pill bg-secondary number-badge">11</span>
														</div>
														<div class="main-img-user1 avatar-lg">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/11.jpg'); ?>">
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										<div class="avatar-list avatar-list-stacked">
											<span class="avatar1 brround"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>"></span>
											<span class="avatar1 brround"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>"></span>
											<span class="avatar1 brround"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/8.jpg'); ?>"></span>
											<span class="avatar1 brround"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/10.jpg'); ?>"></span>
											<span class="avatar1 brround"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/12.jpg'); ?>"></span>
