<?= $this->extend('layouts/switcher-main'); ?>
							...
							<div class="card-body d-md-flex">
								<div class="">
									<span class="profile-image pos-relative">
										<img class="br-5" alt="" src="<?php echo base_url('assets/img/faces/profile.jpg'); ?>">
								...
								<div class="my-md-auto mt-4 prof-details">
									...
									<p class="text-muted ms-md-4 ms-0 mb-2"><span><i class="fa fa-phone me-2"></i></span><span class="font-weight-semibold me-2">Phone:</span><span>+94 12345 6789</span></p>
									<p class="text-muted ms-md-4 ms-0 mb-2"><span><i class="fa fa-envelope me-2"></i></span><span class="font-weight-semibold me-2">Email:</span><span>spruko.space@gmail.com</span></p>
									<p class="text-muted ms-md-4 ms-0 mb-2"><span><i class="fa fa-globe me-2"></i></span><span class="font-weight-semibold me-2">Website</span><span>sprukotechnologies</span></p>
								</div>
							</div>
													...
													<div class="col-12">
														<div class="card mg-b-20 border">
															<div class="card-header p-4">
																<div class="media">
																	<div class="media-user me-2">
																		<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>"></div>
																	</div>
															...
															<div class="card-body">
																...
																<div class="row row-sm">
																	<div class="col">
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-4"
																			src="<?php echo base_url('assets/img/media/1.jpg'); ?>"></a>
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5"
																			src="<?php echo base_url('assets/img/media/2.jpg'); ?>"></a>
																	</div>
																</div>
																		...
																		<div class="demo-avatar-group">
																			<div
																				...
																				<div class="main-img-user"><img alt=""
																						...
																						src="<?php echo base_url('assets/img/faces/12.jpg'); ?>">
																				</div>
																				<div class="main-img-user"><img alt=""
																						class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/12.jpg'); ?>">
																				...
																				<div class="main-img-user online"><img
																						...
																						src="<?php echo base_url('assets/img/faces/5.jpg'); ?>">
																				</div>
																				<div class="main-img-user"><img alt=""
																						class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/6.jpg'); ?>">
																				</div>
														...
														<div class="card mg-b-20 border">
															...
															<div class="card-body h-100">
																...
																<div class="row row-sm">
																	<div class="col">
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-4"
																			src="<?php echo base_url('assets/img/media/4.jpg'); ?>"></a>
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5 mb-2 mt-2"
																			src="<?php echo base_url('assets/img/media/1.jpg'); ?>"></a>
																	</div>
																</div>
																<div class="media mg-t-15 profile-footer">
																	<div class="media-user me-2">
																		<div class="demo-avatar-group">
																			<div
																				...
																				<div class="main-img-user online"><img
																						alt="" class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/7.jpg'); ?>">
																				</div>
																				<div class="main-img-user online"><img
																						alt="" class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/5.jpg'); ?>">
																...
																<div class="media">
																	<div class="media-user me-2">
																		<div class="main-img-user avatar-md"><img alt=""
																				class="rounded-circle"
																				src="<?php echo base_url('assets/img/faces/6.jpg'); ?>"></div>
																	</div>
																	<div class="media-body">
																		<h6 class="mb-0 ms-2 mg-t-3">Mintrona Pechon
																			Pechon</h6><span class="text-muted ms-2">Sep
																	...
																	<div class="media-user me-2">
																		<div class="demo-avatar-group">
																			<div
																				...
																				<div class="main-img-user"><img alt=""
																						class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/3.jpg'); ?>">
																				</div>
																				<div class="main-img-user"><img alt=""
																						class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/4.jpg'); ?>">
																				</div>
																				<div class="main-img-user online"><img
																						alt="" class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/10.jpg'); ?>">
																				</div>
																				<div class="main-avatar"> +23 </div>
																			</div>
																			<!-- demo-avatar-group -->
														...
														<div class="card border">
															<div class="card-header p-4">
																<div class="media">
																	<div class="media-user me-2">
																		<div class="main-img-user avatar-md"><img alt=""
																				class="rounded-circle"
																				src="<?php echo base_url('assets/img/faces/2.jpg'); ?>"></div>
																	</div>
																	<div class="media-body">
																		<h6 class="mb-0 ms-2 mg-t-3">Mintrona Pechon
																			Pechon</h6><span class="text-muted ms-2">Sep
															...
															<div class="card-body h-100">
																...
																<div class="row row-sm">
																	<div class="col">
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-3"
																			src="<?php echo base_url('assets/img/media/4.jpg'); ?>"></a>
																		<a href="<?php echo base_url('gallery'); ?>"><img alt="img" class="wd-200 br-5 mb-2 mt-2"
																			src="<?php echo base_url('assets/img/media/3.jpg'); ?>"></a>
																	</div>
																</div>
																<div class="media mg-t-15 profile-footer">
																	<div class="media-user me-2">
																		<div class="demo-avatar-group">
																			<div
																				...
																				<div class="main-img-user online"><img
																						alt="" class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/11.jpg'); ?>">
																				</div>
																				<div class="main-img-user"><img alt=""
																						class="rounded-circle"
																						src="<?php echo base_url('assets/img/faces/12.jpg'); ?>">
									...
									<div class="card-body border">
										<div class="masonry row">
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/1.jpg'); ?>" class="js-img-viewer"
														data-caption="IMAGE-01" data-id="lion">
														<img src="<?php echo base_url('assets/img/photos/1.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/2.jpg'); ?>" class="js-img-viewer"
														data-caption="IMAGE-02" data-id="camel">
														<img src="<?php echo base_url('assets/img/photos/2.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/3.jpg'); ?>" class="js-img-viewer"
														data-caption="IMAGE-03" data-id="hippo">
														<img src="<?php echo base_url('assets/img/photos/3.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/4.jpg'); ?>" class="js-img-viewer"
														data-caption="IMAGE-04" data-id="koala">
														<img src="<?php echo base_url('assets/img/photos/4.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/5.jpg'); ?>" class="js-img-viewer"
														data-caption="IMAGE-05" data-id=" bear">
														<img src="<?php echo base_url('assets/img/photos/5.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/6.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-06" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/6.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/7.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-07" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/7.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/8.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-08" data-id=" rhino">
														<img src=" <?php echo base_url('assets/img/photos/8.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/9.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-09" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/9.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/10.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-10" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/10.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/11.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-11" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/11.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
											<div class="col-xl-3 col-lg-4 col-sm-6">
												<div class="brick">
													<a href="<?php echo base_url('assets/img/photos/12.jpg'); ?>" class=" js-img-viewer"
														data-caption="IMAGE-11" data-id=" rhino">
														<img src="<?php echo base_url('assets/img/photos/12.jpg'); ?>" alt="" />
													</a>
												</div>
											</div>
										</div>
													...
													<div class="card-body  user-lock text-center">
														...
														<a href="<?php echo base_url('profile'); ?>">
															<img alt="avatar" class="rounded-circle"
																src="<?php echo base_url('assets/img/faces/1.jpg'); ?>">
															<h4 class="fs-16 mb-0 mt-3 text-dark fw-semibold">James
																Thomas</h4>
															<span class="text-muted">Web designer</span>
															<div
																class="mt-3 d-flex text-center justify-content-center">
											...
											<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
												<div class="card custom-card border">
													<div class="card-body  user-lock text-center">
														...
														<a href="<?php echo base_url('profile'); ?>">
															<img alt="avatar" class="rounded-circle"
																src="<?php echo base_url('assets/img/faces/8.jpg'); ?>">
											...
											<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
												<div class="card custom-card border">
													<div class="card-body  user-lock text-center">
														...
														<a href="<?php echo base_url('profile'); ?>">
															<img alt="avatar" class="rounded-circle"
																src="<?php echo base_url('assets/img/faces/2.jpg'); ?>">
    ...
    <?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/SmartPhoto-master/smartphoto.js'); ?>"></script>
