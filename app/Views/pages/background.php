        ...
        <?= $this->section('content'); ?>
				...
				<div class="row">
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card mg-b-20">
							<div class="card-body h-100">
						         <h3 class="card-title  mg-b-10">Gray Set</h3>
								<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
								<div class="example">
									<div class="gray-set d-flex flex-wrap">
										<div class="mb-2bg-gray-100 ht-50 lh-2 text-center me-2 p-3 br-5">.bg-gray-100</div>
										...
										<div class="mb-2 bg-gray-900 ht-50 lh-2 text-center me-2 p-3 br-5 tx-white-7  br5">.bg-gray-900</div>
									</div>
								</div>
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						<div class="card mg-b-20">
							<div class="card-body h-100">
						         <h3 class="card-title  mg-b-10">Solid Background Set</h3>
								<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
								<div class="d-flex flex-wrap">
									<div class="mb-2 bg-primary lh-2 text-center ht-50 me-2 p-3 tx-white  br-5">.bg-primary</div>
									<div class="mb-2 bg-secondary lh-2 text-center ht-50 me-2 p-3 tx-white br-5">.bg-secondary</div>
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						<div class="card mg-b-20">
							<div class="card-body h-100">
						         <h3 class="card-title  mg-b-10">Solid Gradient Background Set</h3>
								<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
								<div class="d-flex flex-wrap">
									...
									<div class="mb-2 bg-pink-gradient  ht-50 lh-2 p-3 tx-white br-5 me-2">.bg-pink-gradient</div>
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card mg-b-20">
							<div class="card-body h-100">
						         <h3 class="card-title  mg-b-10">Transparent White Set</h3>
								<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
								<div class="d-flex flex-wrap">
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover  br-ts-5 br-bs-5" src="<?php echo base_url('assets/img/photos/5.jpg'); ?>">
									...
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover  br-te-5 br-be-5" src="<?php echo base_url('assets/img/photos/5.jpg'); ?>">
					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card">
							<div class="card-body h-100">
						         <h3 class="card-title  mg-b-10">Transparent Black Set</h3>
								<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
								<div class="d-flex flex-wrap">
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover  br-ts-5 br-bs-5" src="<?php echo base_url('assets/img/photos/5.jpg'); ?>">
