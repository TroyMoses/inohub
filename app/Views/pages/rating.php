<?= $this->extend('layouts/switcher-main'); ?>
    ...
    <?= $this->section('scripts'); ?>
		...
		<!-- Star Rating Js-->
		<script src="<?php echo base_url('assets/plugins/rating/jquery-rate-picker.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/rating/rating-picker.js'); ?>"></script>

		<!-- Star Rating-1 Js-->
		<script src="<?php echo base_url('assets/plugins/ratings-2/jquery.star-rating.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/ratings-2/star-rating.js'); ?>"></script>
