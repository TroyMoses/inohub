<?= $this->extend('layouts/switcher-main'); ?>
										...
										<table id="user-datatable" class="table table-bordered text-nowrap border-bottom Userlist">
											...
											<tbody>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/9.jpg'); ?>">
														</div>
													</td>
													<td>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/13.jpg'); ?>">
														</div>
													</td>
													<td>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/14.jpg'); ?>">
														</div>
													</td>
													<td>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/15.jpg'); ?>">
														</div>
													</td>
													<td>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/16.jpg'); ?>">
														</div>
													</td>
													<td>
												...
												<tr>
													<td class="text-center">
														<div class="avatar-md  rounded-circle">
															<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/17.jpg'); ?>">
														</div>
													</td>
													<td>
    ...
    <?= $this->section('scripts'); ?> 
		...
		<script src="<?php echo base_url('assets/js/user-list.js'); ?>"></script>
