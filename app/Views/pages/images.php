							...
							<div class="text-wrap">
								<div class="example">
									<div>
										...
										<img alt="Responsive image" class="img-fluid br-5" src="<?php echo base_url('assets/img/photos/1.jpg'); ?>">
                                        </a>
									</div>
								</div>
							</div>
								...
								<div class="example">
									<div class="bd pd-20 clearfix">
									   <a href="<?php echo base_url('gallery'); ?>">
											...
											<img alt="" class="rounded float-sm-right wd-100p wd-sm-200 mg-t-10 mg-lg-t-0" src="<?php echo base_url('assets/img/photos/1.jpg'); ?>">
                                        </a>	
									</div>
								</div>
							</div>
							...
							<div class="text-wrap">
								<div class="example">
									<figure class="pos-relative  br-5 mg-b-0 wd-sm-80p wd-md-50p">
									    <a href="<?php echo base_url('gallery'); ?>">  
										    <img alt="Responsive image" class="img-fit-cover  br-5" src="<?php echo base_url('assets/img/photos/1.jpg'); ?>">
                                        </a>	
										<figcaption class="pos-absolute  br-5 a-0 pd-25 bg-black-5 tx-white-8">
