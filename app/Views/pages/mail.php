							...
							<div class="card mt-3">
								<div class="card-body">
									...
									<nav class="nav main-nav-column">
											...
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/img/faces/1.jpg'); ?>"></div>
												<div class="main-contact-body">
													<h6>Cherry Blossom</h6><span class="phone">+1-644-767-890</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/img/faces/12.jpg'); ?>"></div>
												<div class="main-contact-body">
