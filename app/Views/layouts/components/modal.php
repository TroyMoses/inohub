			    ...
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            <div class="modal-header border-bottom">
			                <h6 class="modal-title">School Branches</h6><button aria-label="Close" class="btn-close"
			            ...
			            <div class="modal-body">
			                <ul class="row p-3">
			                    ...
			                    <li class="col-lg-12 mb-2">
			                        <a href="#" data-current="<?php echo h_session('branch_id') == $branch['id'] ? 'yes':'no' ?> " data-id="<?= esc( h_encrypt_decrypt($branch['id']) ); ?>" class="switcher-branch-btn btn btn-country btn-lg btn-block <?php echo h_session('branch_id') == $branch['id'] ? 'active':'' ?>">
			                            <span class="country-selector"><img alt=""
			                                    src="<?php echo base_url('assets/img/flags/us_flag.jpg'); ?>"
			                                    class="me-3 language"></span>Switch to <?= esc($branch['branch_name']); ?>
			                        </a>
			                    </li>
								<?php endforeach; ?>
			                </ul>
