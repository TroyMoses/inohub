								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="<?php echo h_session('image_url') ? base_url(h_session('image_url')): base_url('assets/img/faces/2.jpg'); ?>" class=""></a>
											<div class="dropdown-menu">
												<div class="menu-header-content p-3 border-bottom">
													<div class="d-flex wd-100p">
														<div class="main-img-user"><img alt="" src="<?php echo h_session('image_url') ? base_url(h_session('image_url')): base_url('assets/img/faces/2.jpg'); ?>" class=""></div>
														<div class="ms-3 my-auto">
															<h6 class="tx-15 font-weight-semibold mb-0"><?php echo h_session('people_name') ? h_session('people_name') :'No Name' ?></h6><span class="dropdown-title-text subtext op-6  tx-12"><?php echo h_session('person_type') ? h_session('person_type') :'No User Type' ?></span>
														</div>
													</div>
												</div>
												<a class="dropdown-item" data-bs-target="#user-edit-user-account" data-bs-toggle="modal" href=""><i class="far fa-user-circle"></i>Edit Account</a>
												<a class="dropdown-item" data-href="<?php echo base_url('serviceAuth/logout'); ?>" id="school-logout-href" href=""><i class="far fa-arrow-alt-circle-left"></i> Log Out</a>
											</div>
										</li>
										<li>
