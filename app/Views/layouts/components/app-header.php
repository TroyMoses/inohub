						...
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="<?php echo base_url('index'); ?>" class="header-logo">
									<img src="<?php echo base_url('assets/img/brand/logo.png'); ?>" class="mobile-logo logo-1" alt="logo">
									<img src="<?php echo base_url('assets/img/brand/logo-white.png'); ?>" class="mobile-logo dark-logo-1" alt="logo">
								</a>
							</div>
							...
							<div class="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">
								<input class="form-control" placeholder="Search Student by Name || Student Number..." type="search">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
											...
											<div class="dropdown-menu">
												...
												<div class="main-cart-list cart-scroll">
													<div class="d-flex border-bottom main-cart-item">
														<div>
															<a class="d-flex p-3"  href="<?php echo base_url('product-details'); ?>">
																<div class="drop-img cover-image" data-image-src="<?php echo base_url('assets/img/ecommerce/05.jpg'); ?>">
																</div>
													...
													<div class="d-flex border-bottom main-cart-item">
														<div>
															<a class="d-flex p-3"  href="<?php echo base_url('product-details'); ?>">
																<div class="drop-img cover-image" data-image-src="<?php echo base_url('assets/img/ecommerce/02.jpg'); ?>">
																</div>
																<div class="ms-3 text-start">
													...
													<div class="d-flex border-bottom main-cart-item">
														<div>
															<a class="d-flex p-3"  href="<?php echo base_url('product-details'); ?>">
																<div class="drop-img cover-image" data-image-src="<?php echo base_url('assets/img/ecommerce/12.jpg'); ?>">
																</div>
																<div class="ms-3 text-start">
													...
													<div class="d-flex border-bottom main-cart-item">
														<div>
															<a class="d-flex p-3"  href="<?php echo base_url('product-details'); ?>">
																<div class="drop-img cover-image" data-image-src="<?php echo base_url('assets/img/ecommerce/06.jpg'); ?>">
																</div>
																<div class="ms-3 text-start">
													...
													<div class="d-flex border-bottom main-cart-item">
														<div>
															<a class="d-flex p-3"  href="<?php echo base_url('product-details'); ?>">
																<div class="drop-img cover-image" data-image-src="<?php echo base_url('assets/img/ecommerce/04.jpg'); ?>">
																</div>
																<div class="ms-3 text-start">
												...
												<div class="dropdown-footer text-start">
													<a class="btn btn-primary btn-sm btn-w-md" href="<?php echo base_url('check-out'); ?>">Checkout</a>
										...
										<li class="dropdown nav-item  main-header-message ">
											...
											<div class="dropdown-menu">
												...
												<div class="main-message-list chat-scroll">
													<a href="<?php echo base_url('chat'); ?>" class="dropdown-item d-flex border-bottom">
												...
												<div class="text-center dropdown-footer">
													<a class="btn btn-primary btn-sm btn-block text-center"  href="<?php echo base_url('chat'); ?>">VIEW ALL</a>
												</div>
											</div>
										</li>
										<li class="dropdown nav-item main-header-notification d-flex">
											...
											<div class="dropdown-menu">
												...
												<div class="main-notification-list Notification-scroll">
													<a class="d-flex p-3 border-bottom" href="<?php echo base_url('mail'); ?>">
												...
												<div class="dropdown-footer">
													<a class="btn btn-primary btn-sm btn-block" href="<?php echo base_url('mail'); ?>">VIEW ALL</a>
												</div>
											</div>
										</li>
										...
										<li class="nav-link search-icon d-lg-none d-block">
											<form class="navbar-form" role="search">
												<div class="input-group">
													<input type="text" class="form-control" placeholder="Search Student by Name || Student Number">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>" class=""></a>
											<div class="dropdown-menu">
												<div class="menu-header-content p-3 border-bottom">
													<div class="d-flex wd-100p">
														<div class="main-img-user"><img alt="" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>" class=""></div>
												...
												<a class="dropdown-item" href="<?php echo base_url('profile'); ?>"><i class="far fa-user-circle"></i>Profile</a>
												<a class="dropdown-item" href="<?php echo base_url('chat'); ?>"><i class="far fa-smile"></i> chat</a>
												<a class="dropdown-item" href="<?php echo base_url('mail-read'); ?>"><i class="far fa-envelope "></i>Inbox</a>
												<a class="dropdown-item" href="<?php echo base_url('mail'); ?>"><i class="far fa-comment-dots"></i>Messages</a>
												<a class="dropdown-item" href="<?php echo base_url('mail-settings'); ?>"><i class="far fa-sun"></i>  Settings</a>
												<a class="dropdown-item" href="<?php echo base_url('signup'); ?>"><i class="far fa-arrow-alt-circle-left"></i> Sign Out</a>
											</div>
										</li>
									</ul>
								</div>
